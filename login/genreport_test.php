<?php
	...
	$q = "SELECT * FROM tbl_ss_qualify WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13'";
	...
	foreach($outliers as $outlier) {
		...
		if ($outlier['cancer_type'] == "N/A") {
			...
			$q = "SELECT * FROM tbl_ss_qualifypers WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND cancer_type = \"" . $outlier['cancer_type'] . "\"";
		...
		if (($insurance == $outlier['insurance']) &&			
			...
			$cancer_type) {
				if (($outlier['age_required']) && (!isset($_POST[$outlier['field_name'] . "_age"]))) {
					...
					$q = "SELECT * FROM tbl_ss_qualifygene WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND gene IN (\"EPCAM\",\"MLH1\",\"MSH2\",\"MSH6\",\"PMS2\")";
					$result = $db->query($q);
					if ($result) {
						$cancer_found_lynch = 1;
					} 
					$q = "SELECT * FROM tbl_ss_qualifygene WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND gene IN (\"ATM\",\"BARD1\",\"BRCA1\",\"BRCA2\",\"BRIP1\",\"CDH1\",\"CHEK2\",\"MUTYH\",\"PALB2\",\"PTEN\",\"RAD51C\",\"RAD51D\",\"STK11\",\"TP53\")";						
					$result = $db->query($q);
					if ($result) {
						$cancer_found_brca = 1;
					} else {
	...
	if (($qualify["insurance"] == "Aetna") || ($qualify["insurance"] == "Medicare")) {
		...
		$q = "SELECT * FROM tbl_ss_qualifyans WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND Guid_outlier IS NULL";
		$answers = $db->query($q);
		if ($answers) {
	...
	$q = "SELECT * FROM tbl_ss_qualifyans WHERE cancer_personal IS NOT NULL AND Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13'";
	...
	$q = "SELECT a.relative FROM tblfirstdegrel tr LEFT JOIN tbl_ss_qualifyans a ON a.relative = tr.value WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND a.relative IS NOT NULL";
	...
	$q = "SELECT a.relative FROM tblseconddegrel tr LEFT JOIN tbl_ss_qualifyans a ON a.relative = tr.value WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND a.relative IS NOT NULL";
	...
	$q = "SELECT relative FROM tblthirddegrel tr LEFT JOIN tbl_ss_qualifyans a ON a.relative = tr.value WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13'";
...
echo '
	...
	$guideline = array();
	$q = "SELECT * FROM tbl_ss_qualify WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND gene_mutation = \"Yes\"";
	...
	if ($qualify_gene_mutation) {				
		...
		$q = "SELECT * FROM tbl_ss_qualifygene WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13'";
		...
		foreach($family_genes as $family_gene) {			
			if (($family_gene['gene_relation'] == "Mother") || ($family_gene['gene_relation'] == "Father") || ($family_gene['gene_relation'] == "Maternal Grandfather") || ($family_gene['gene_relation'] == "Maternal Grandmother") || ($family_gene['gene_relation'] == "Paternal Grandfather") || ($family_gene['gene_relation'] == "Paternal Grandmother") || ($family_gene['gene_relation'] == "Maternal Great-Grandfather") || ($family_gene['gene_relation'] == "Maternal Great-Grandmother") || ($family_gene['gene_relation'] == "Paternal Great-Grandfather") || ($family_gene['gene_relation'] == "Paternal Great-Grandmother")) {			
				...
				if (isset($count[$family_gene['gene_relation']])) {
					$count[$family_gene['gene_relation']] += 1; 
				} else {
					$count[$family_gene['gene_relation']] = 1; 
				}
...
echo '
	...
	$q = "SELECT a.age_personal, a.cancer_personal, o.guideline_met FROM tbl_ss_qualifyans a LEFT JOIN tbloutlier o ON a.Guid_outlier = o.Guid_outlier WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND a.Guid_outlier IS NOT NULL";
	...
	$q = "SELECT a.age_personal, a.cancer_personal, q.guideline_met FROM tbl_ss_qualifyans a LEFT JOIN tblcancerquestion q ON a.Guid_question = q.Guid_question WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND cancer_personal IS NOT NULL AND a.Guid_outlier IS NULL ORDER BY q.sort_order";	
	...
	if ($personals) {	
		...
		$q = "SELECT q.guideline_met FROM tbl_ss_qualifyans a LEFT JOIN tblcancerquestion q ON a.Guid_question = q.Guid_question WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13' AND a.relative IS NOT NULL AND a.Guid_outlier IS NULL GROUP BY a.Guid_question";
		$result = $db->query($q);
		if ($result) {
...
echo '
	...
	if ($outliers) {
		foreach($outliers as $outlier) {
			$sql = "SELECT * FROM tbl_ss_qualify WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13'";
	...
	$q = "SELECT q.guideline_met FROM tbl_ss_qualifyans a LEFT JOIN tblcancerquestion q ON a.Guid_question = q.Guid_question WHERE Guid_qualify=2314 AND Date_created = '2018-11-07 12:55:13'";
	$results = $db->query($q);
	...
	$q = "SELECT * FROM tbl_ss_qualifypers WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND cancer_type =\"No Cancer/None of the Above\"";
	$no_p_cancer_history = $db->query($q);
	
	$q = "SELECT * FROM tbl_ss_qualifyfam WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND cancer_type =\"No Cancer/None of the Above\"";
...
echo '
	...
	if ($qualify["ashkenazi"] == "Yes") {
		$q = "SELECT * FROM tbl_ss_qualifyans WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND (cancer_personal IN(\"Breast\", \"Ovarian\", \"Pancreatic\", \"Prostate\") OR cancer_type IN(\"Breast\", \"Ovarian\", \"Pancreatic\", \"Prostate\"))";
		$result = $db->row($q);
...
echo '
	...
	$q = "SELECT * FROM tbl_ss_qualifyans WHERE Guid_qualify = 2314 AND Date_created = '2018-11-07 12:55:13' AND gene_mutation = \"Yes\"";
