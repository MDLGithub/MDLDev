                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">                                        
                                    <a class="openUserInfoModal" data-id="<?php echo $user['Guid_user']; ?>">
...
<div id="patient-info-box" class="modalBlock hidden">
    <div class="contentBlock">
        <a class="close closeModal">X</a>        
        ...
        <form action="" method="POST" enctype="multipart/form-data"> 
            ...
            <div class="row actionButtons">
                <div class="col-md-6 col-md-offset-3 pT-20">
                    <button name="save_user" type="button" class="button btn-inline">Save</button>
                </div>
            </div>
