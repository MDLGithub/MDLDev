...
class Db {
    ...
    public function bind($para, $value) {
        $this->parameters[sizeof($this->parameters)] = ":" . $para . "\x7F" . ($value);// utf8_encode( $value )
    }
     ...
     * If the SQL statement is a DELETE, INSERT, or UPDATE statement it 
    ...
    /**
     * Returns All data from given table
     * 
     * @param type $tableName
     */
    public function selectAll($table, $orderQuery=NULL) {
        $query = $this->query("SELECT * FROM $table $orderQuery");
        return $query;        
    }
