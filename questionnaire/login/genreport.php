...
<?php
	...
	//$yesorno = strtolower($qualify_request['qualified']);
	$yesorno = "Yes";
	echo '
	<header id="app_head">
...
//	} else {
echo '
					<figure id="app_logo_mdl"><img src="' . $directory . '/assets/images/logo_mdl.png" alt="MDL"></figure>';
//	}
echo '
					<span class="divide"></span>
					<figure id="app_logo_brccare"><img class="brccare" src="' . $directory . '/assets/images/logo_brcacare.png" alt="BRCAcare"></figure>
...
echo '
	...
	if (strlen($qualify['provider_id'])) {
		$q = "SELECT name FROM tblprovider WHERE Guid_provider = " . $qualify['provider_id'];	
		$result = $db->row($q);
		$physician_name = $result['name'];
	}	
...
<?php
	...
	if (strlen($cancer_diagnosed)) { echo "<img src=\"/dev/login/assets/images/icon_ch.png\" alt=\"Cancer History\">"; }
	else {echo "<img src=\"/dev/login/assets/images/icon_nch_blk.png\" alt=\"No History\">";}
?>
				</span>
				<strong><?php echo $relation?></strong>
			</button>
